...
export async function runWhoAmI() {
    ...
    if (!apiUrl) {
        banner(RED, "WAYLY WHOAMI — MISCONFIG", [
            ...
            "   Expected value: https://mobile-parity-sweep.preview.emergentagent.com",
            "",
...
```
┌── WAYLY WHOAMI — OK ────────────────────────────────
│  API URL     : https://mobile-parity-sweep.preview.emergentagent.com
...
```
EXPO_PUBLIC_WAYLY_API_URL=https://mobile-parity-sweep.preview.emergentagent.com
```
