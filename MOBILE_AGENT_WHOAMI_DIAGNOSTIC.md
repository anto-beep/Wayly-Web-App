...
export async function runWhoAmI() {
    ...
    if (!apiUrl) {
        banner(RED, "WAYLY WHOAMI — MISCONFIG", [
            ...
            "   Expected value: https://wayly-rn-build.preview.emergentagent.com",
            "",
    ...
    if (isLocalhost && Constants.appOwnership === "expo") {
        banner(YELLOW, "WAYLY WHOAMI — LOCALHOST WARNING", [
            ...
            "     https://wayly-rn-build.preview.emergentagent.com",
...
```
┌── WAYLY WHOAMI — OK ────────────────────────────────
│  API URL     : https://wayly-rn-build.preview.emergentagent.com
...
```
EXPO_PUBLIC_WAYLY_API_URL=https://wayly-rn-build.preview.emergentagent.com
```
