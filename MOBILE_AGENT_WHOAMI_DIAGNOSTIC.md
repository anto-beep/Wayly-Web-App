...
export async function runWhoAmI() {
    ...
    if (!apiUrl) {
        banner(RED, "WAYLY WHOAMI — MISCONFIG", [
            ...
            "   Expected value: https://wayly-engagement-hub.preview.emergentagent.com",
            "",
    ...
    if (isLocalhost && Constants.appOwnership === "expo") {
        banner(YELLOW, "WAYLY WHOAMI — LOCALHOST WARNING", [
            ...
            "     https://wayly-engagement-hub.preview.emergentagent.com",
...
```
┌── WAYLY WHOAMI — OK ────────────────────────────────
│  API URL     : https://wayly-engagement-hub.preview.emergentagent.com
...
```
EXPO_PUBLIC_WAYLY_API_URL=https://wayly-engagement-hub.preview.emergentagent.com
```
