...
export async function runWhoAmI() {
    ...
    if (!apiUrl) {
        banner(RED, "WAYLY WHOAMI — MISCONFIG", [
            ...
            "   Expected value: https://mobile-web-sync-35.preview.emergentagent.com",
            "",
    ...
    if (isLocalhost && Constants.appOwnership === "expo") {
        banner(YELLOW, "WAYLY WHOAMI — LOCALHOST WARNING", [
            ...
            "     https://mobile-web-sync-35.preview.emergentagent.com",
...
```
┌── WAYLY WHOAMI — OK ────────────────────────────────
│  API URL     : https://mobile-web-sync-35.preview.emergentagent.com
...
```
EXPO_PUBLIC_WAYLY_API_URL=https://mobile-web-sync-35.preview.emergentagent.com
```
