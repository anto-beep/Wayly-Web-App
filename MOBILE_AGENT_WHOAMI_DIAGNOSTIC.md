...
export async function runWhoAmI() {
    ...
    if (!apiUrl) {
        banner(RED, "WAYLY WHOAMI — MISCONFIG", [
            ...
            "   Expected value: https://final-verify-web.preview.emergentagent.com",
            "",
    ...
    if (isLocalhost && Constants.appOwnership === "expo") {
        banner(YELLOW, "WAYLY WHOAMI — LOCALHOST WARNING", [
            ...
            "     https://final-verify-web.preview.emergentagent.com",
...
```
┌── WAYLY WHOAMI — OK ────────────────────────────────
│  API URL     : https://final-verify-web.preview.emergentagent.com
...
```
EXPO_PUBLIC_WAYLY_API_URL=https://final-verify-web.preview.emergentagent.com
```
