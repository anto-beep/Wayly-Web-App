...
export async function runWhoAmI() {
    ...
    if (!apiUrl) {
        banner(RED, "WAYLY WHOAMI — MISCONFIG", [
            ...
            "   Expected value: https://statement-checker-3.preview.emergentagent.com",
            "",
...
```
┌── WAYLY WHOAMI — OK ────────────────────────────────
│  API URL     : https://statement-checker-3.preview.emergentagent.com
...
```
EXPO_PUBLIC_WAYLY_API_URL=https://statement-checker-3.preview.emergentagent.com
```
