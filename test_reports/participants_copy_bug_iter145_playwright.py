...
async def run(page):
    ...
    try:
        ...
        await page.goto("https://mobile-exact-parity.preview.emergentagent.com/login", wait_until="domcontentloaded")
        ...
        await page.goto("https://mobile-exact-parity.preview.emergentagent.com/app/participants", wait_until="domcontentloaded", timeout=20000)
