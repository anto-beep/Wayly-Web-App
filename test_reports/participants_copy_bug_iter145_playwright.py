...
async def run(page):
    ...
    try:
        ...
        await page.goto("https://mobile-web-sync-35.preview.emergentagent.com/login", wait_until="domcontentloaded")
        ...
        await page.goto("https://mobile-web-sync-35.preview.emergentagent.com/app/participants", wait_until="domcontentloaded", timeout=20000)
