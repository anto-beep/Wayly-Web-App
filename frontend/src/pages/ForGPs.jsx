        ...
        <div className="min-h-screen bg-kindred">
                ...
                <div className="grid lg:grid-cols-2 gap-10 items-center">
                    <div>
                        ...
                        <div className="mt-7 flex items-center gap-3 flex-wrap">
                            <Link to="/contact" data-testid="gp-book-call" className="bg-primary-k text-white rounded-lg px-6 py-3 hover:bg-[#091D33] transition-colors">
            ...
            <section className="bg-primary-k">
                <div className="mx-auto max-w-4xl px-6 py-16 text-center">
                    <h2 className="font-heading text-4xl sm:text-5xl text-white tracking-tight">15 minutes. We will bring the cards.</h2>
                    <Link to="/contact" className="mt-8 inline-flex items-center gap-2 bg-gold text-white font-medium rounded-lg px-6 py-3 hover:bg-[#1FA8B8]">Book a call <ArrowRight className="h-4 w-4" /></Link>
                </div>
            </section>
            <Footer />
        </div>
