    ...
    return (
        <div className="space-y-6" data-testid="docvault-page">
            ...
            <header className="flex flex-wrap items-end justify-between gap-4">
                <div>
                    <span className="overline">Document Vault</span>
                    <h1 className="font-heading text-3xl text-primary-k mt-1 tracking-tight">All your aged-care paperwork, in one place</h1>
