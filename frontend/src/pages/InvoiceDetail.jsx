        ...
        <div className="space-y-6" data-testid="invoice-detail-page">
            ...
            <SmartAISummary
                ...
                context={{
                    ...
                    invoice_date: inv.invoice_date,
                    document_shape: inv.document_shape,
                    line_item_count: (inv?.reconciliation?.lines || []).length,
                    finding_count: (inv?.reconciliation?.findings || []).length,
                    findings_summary: (inv?.reconciliation?.findings || []).slice(0, 6).map((f) => ({
                        severity: f.severity || f.tier,
                        title: f.title || f.label,
                        amount: f?.financial_impact?.amount || 0,
                    })),
                }}
            />
