        ...
        <div className="min-h-screen bg-kindred" data-testid="participant-view">
            ...
            <div className="max-w-3xl mx-auto px-6 py-8 space-y-10">
                ...
                <div className="bg-surface border border-kindred rounded-3xl p-10" data-testid="wellbeing-card">
                    ...
                    {isExpired ? (
                        <p className="mt-4 text-2xl text-muted-k leading-snug" data-testid="wellbeing-locked">
                            Daily check-ins are paused. Ask the primary caregiver to subscribe to turn them back on.
                        </p>
                    ) : checkedIn ? (
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <button
                        ...
                        className="bg-terracotta text-white rounded-3xl p-10 flex flex-col items-center justify-center text-center gap-3 hover:bg-[#8d4a3c] transition-colors min-h-[200px] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        <AlertOctagon className="h-12 w-12" />
                        <span className="text-3xl font-semibold">{isExpired ? "Paused, subscribe to resume" : submitting ? "Sending…" : "Something's not right"}</span>
                    </button>
                </div>
            </div>
        </div>
