            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    <button
                        ...
                        className="inline-flex items-center gap-2 text-sm border item-sage rounded-full px-4 py-2 text-sage hover:opacity-80 disabled:opacity-40 disabled:cursor-not-allowed"
                    ...
                    <Link
                        ...
                        className="inline-flex items-center gap-2 text-sm border item-clay rounded-full px-4 py-2 text-clay-k hover:opacity-80"
                    >
                        <Archive className="h-3.5 w-3.5" /> Archived
                        {archivedCount > 0 && <span className="tabular-nums text-xs">({archivedCount})</span>}
                    </Link>
                    <Link
                                        ...
                                        >
                                            <td colSpan={6} className="p-0">
                                                <Link
                                                    ...
                                                    className="block px-5 py-4 md:px-6 md:py-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-k focus-visible:ring-offset-2 rounded"
                                                >
                                                    {/* Mobile: stacked card */}
                                                    <div className="md:hidden">
                                                        <div className="flex items-start justify-between gap-3">
                                                            <div className="min-w-0">
                                                                <div className="font-medium text-primary-k" title={periodExact(s)}>{periodCompact(s)}</div>
                                                                <div className="text-xs text-muted-k truncate mt-0.5" title={prov}>{prov}</div>
                                                            </div>
                                                        ...
                                                        <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-k">
                                                            <span className="tabular-nums text-primary-k">Gross {formatAUD2(gross)}</span>
                                                            {closing != null && <span className="tabular-nums">Closing {formatAUD2(closing)}</span>}
                                                            <span>{uploadedLabel(s.uploaded_at)}</span>
                                                        </div>
                                                    </div>
