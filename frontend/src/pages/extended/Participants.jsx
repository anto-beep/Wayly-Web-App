...
const EMPTY_FORM = {
    ...
    classification: "", provider_name: "", provider_email: "", statement_format: "unknown",
};
                    ...
                    <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        {step === "form" && (
                            <div className="p-5 space-y-3" data-testid="add-form-step">
                                ...
                                <div>
                                    <FieldLabelText optional>Provider email</FieldLabelText>
                                    <input
                                        type="email"
                                        value={form.provider_email}
                                        onChange={(e) => setForm({ ...form, provider_email: e.target.value })}
                                        placeholder="e.g. billing@theprovider.com.au"
                                        className="w-full mt-1 rounded-md border border-kindred px-3 py-2"
                                        data-testid="form-provider-email"
                                    />
                                    <p className="text-[11px] text-muted-k mt-1">We use this to pre-address letters and emails to your provider.</p>
                                </div>
                                <div>
                    ...
                    <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl max-h-[92vh] flex flex-col">
                        ...
                        <div className="p-5 space-y-5 overflow-y-auto">
                            ...
                            <fieldset className="space-y-3">
                                ...
                                <div>
                                    <label className="text-xs text-muted-k">Provider email</label>
                                    <input
                                        type="email"
                                ...
                                onClick={async () => {
                                    ...
                                    try {
                                        ...
                                        const optionalStrFields = [
                                            "preferred_name", "provider_name", "provider_email", "mac_reference_number",
