        ...
        <div className="mx-auto max-w-4xl p-6 space-y-6" data-testid="scenario-capture-page">
            <header>
                ...
                <p className="mt-2 text-sm text-muted-k max-w-2xl">
                    Record what's happened to <strong>{participant.first_name}</strong>. We will update
                    their status and any related flags. You can always undo by logging the opposite
                    event.
                </p>
            </header>
