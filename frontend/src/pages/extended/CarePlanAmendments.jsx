...
export default function CarePlanAmendments() {
    ...
    return (
        <div className="space-y-6" data-testid="amendments-page">
            ...
            {/* UI-1 §14.2, verbatim intro copy */}
            <div className="bg-surface border border-kindred rounded-2xl p-6 text-sm leading-relaxed text-primary-k max-w-3xl" data-testid="amendments-intro">
                <p>
                    A care plan sets out the services a participant has been approved to receive under Support at Home, how often, and from which provider. It changes over time. Sometimes the participant's needs increase, sometimes services are added or removed, and sometimes a provider proposes a different mix of supports.
                </p>
                <p className="mt-3">
                    This screen shows every version of the care plan and what changed between them. For each change, you can see what was added, what was removed, what the funding impact is, and who approved it. If a change does not look right, you can flag it for review.
                </p>
                <p className="mt-3 text-sm text-muted-k">
                    <strong className="text-primary-k">Tip:</strong> Big changes, like moving from one classification to another or starting a short-term pathway, should always show up here within a few days of being approved. If you expected a change and do not see it, raise it with your provider.
                </p>
            </div>
