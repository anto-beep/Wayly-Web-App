                    ...
                    {error ? (
                        ...
                        <>
                            ...
                            <p className="mt-2 text-sm text-muted-k leading-relaxed">
                                You are being added as a <span className="font-medium text-primary-k capitalize">{invite.role?.replace("_", " ")}</span> on <span className="font-medium text-primary-k">{invite.household_name}</span>'s Wayly.
                            </p>
                            {invite.note && (
                            ...
                            {!user ? (
                                ...
                                <p className="mt-6 text-sm text-terracotta">
                                    You are signed in as <span className="font-medium">{user.email}</span>, but this invite is for <span className="font-medium">{invite.email}</span>. Sign out and use the correct account.
                                </p>
                            ) : (
                                <button
                                    onClick={accept}
