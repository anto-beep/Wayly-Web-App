...
export default function ClassificationCheck() {
    ...
    const submit = async () => {
        ...
        try {
            ...
            setTimeout(() => {
                document.querySelector("[data-testid='csc-result-header']")?.scrollIntoView({ behavior: "smooth" });
            }, 80);
        } catch (e) {
    ...
    return (
        <div className="min-h-screen bg-kindred">
            ...
            {result && (
                <section className="mx-auto max-w-3xl px-6 pb-20 space-y-5 animate-fade-up" data-testid="csc-result">
