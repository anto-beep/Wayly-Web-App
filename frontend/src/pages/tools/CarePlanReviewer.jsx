...
export default function CarePlanReviewer() {
    ...
    if (access === "blocked") return (<div className="min-h-screen bg-kindred"><MarketingHeader /><section className="mx-auto max-w-4xl px-6 pt-8"><AIAccuracyBanner text={TOOL_DISCLAIMERS["care-plan-reviewer"]} /></section><ToolGate toolName="Care Plan Reviewer"><ScreenshotStatement /></ToolGate><Footer /></div>);
