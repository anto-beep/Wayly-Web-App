            ...
            <div style={S.wrap}>
                ...
                <aside style={S.left} data-testid="admin-login-context">
                    ...
                    <div style={{ marginTop: 20, display: "flex", gap: 14, flexWrap: "wrap", fontSize: 12.5 }}>
                        ...
                        <a className="admin-link" href="mailto:hello@wayly.com.au?subject=Admin%20access">Need access?</a>
                ...
                <div className="admin-card" style={S.right}>
                    {step === STEP.CREDENTIALS && (
                        <form onSubmit={submitCreds} data-testid="admin-login-form">
                            ...
                            <p style={S.helpLine}>
                                Locked out? <a className="admin-link" href="mailto:hello@wayly.com.au?subject=Admin%20lockout">Email the on-call</a>.
                            </p>
                        </form>
                    )}
                    ...
                    {backupCodes && (
                        <div data-testid="admin-2fa-backup-codes">
                            ...
                            <p style={{ color: "var(--admin-muted)", marginBottom: 16, fontSize: 13 }}>
                                ...
                                <strong style={{ color: "var(--admin-warning)" }}>This is the only time we'll show them.</strong>
                            </p>
                    ...
                    {step === STEP.VERIFY && (
                        <form onSubmit={submitVerify} data-testid="admin-2fa-verify">
                            ...
                            <p style={S.helpLine}>
                                ...
                                <a className="admin-link" href="mailto:hello@wayly.com.au?subject=Admin%202FA%20recovery">request recovery</a>.
                            </p>
                        </form>
                    )}
                </div>
