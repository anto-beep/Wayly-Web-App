                        ...
                        <div className="space-y-5">
                            ...
                            <div className="border-t border-kindred pt-5 flex flex-wrap items-center justify-between gap-3">
                                <p className="text-xs text-muted-k max-w-md leading-relaxed">
                                    Read-only · You are viewing this client's data under your Adviser subscription. Treat as confidential.
                                </p>
                                <button
                                    type="button"
                ...
                <section className="mt-8">
                    {loading ? (
                        ...
                        <div className="bg-surface border border-kindred rounded-xl p-10 text-center" data-testid="adviser-empty">
                            ...
                            <p className="mt-2 text-sm text-muted-k">Add your first client above, invite them by email and we will link their household automatically when they sign up.</p>
                        </div>
                    ) : (
