...
export default function Contact() {
    ...
    return (
        <div className="min-h-screen bg-kindred">
            <SeoHead {...SEO.contact} />
            <MarketingHeader />
            <section className="mx-auto max-w-6xl px-6 pt-10 pb-6" data-testid="contact-page">
            ...
            <section className="mx-auto max-w-6xl px-6 pb-10 grid lg:grid-cols-3 gap-6 items-start">
                ...
                <aside className="space-y-3" data-testid="contact-info-cards">
                    ...
                    <div className="bg-surface border border-kindred rounded-xl p-4">
                        ...
                        <div className="overline mt-2">Where we are</div>
                    ...
                    <div className="bg-surface-2 border border-kindred rounded-xl p-4">
                        ...
                        <div className="overline mt-2">Need help right now?</div>
