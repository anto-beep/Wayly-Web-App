...
import {
    ...
    Crown, Lock, Calendar, TrendingUp, Bell, CheckCircle2, Clock, Users,
} from "lucide-react";
                ...
                <>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4" data-testid="dashboard-stats">
                        ...
                        <Link to="/app/statements" className="bg-surface border border-kindred rounded-xl p-5 hover:border-primary-k hover:shadow-sm transition-all" data-testid="stat-statements">
                            ...
                            <div className="text-xs text-muted-k mt-0.5">
                                {statements[0] ? `Latest ${formatDate(statements[0].uploaded_at || statements[0].created_at || Date.now())}` : "None yet"}
                            </div>
                        </Link>
