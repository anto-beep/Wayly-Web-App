...
import { ArrowLeft, Loader2, Check, Eye, EyeOff, Smartphone } from "lucide-react";
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white border border-[#CFE0F0] rounded-2xl p-8 shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
                    ...
                    {sent ? (
                        ...
                        <>
                            <p className="mt-2 text-sm text-[#6B7280]">Enter your email, we will send a link to reset it.</p>
        ...
        <div className="min-h-screen bg-[#EAF4FB] flex items-center justify-center px-6">
            <div className="w-full max-w-md">
                ...
                <div className="bg-white border border-[#CFE0F0] rounded-2xl p-8 shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
                    ...
                    {token && !done && (
                        <a
                            href={`wayly://reset?token=${encodeURIComponent(token)}`}
                            data-testid="reset-open-in-app"
                            className="mt-4 w-full inline-flex items-center justify-center gap-2 rounded-md border border-[#0E2A47] text-[#0E2A47] py-2.5 text-sm hover:bg-[#0E2A47] hover:text-white transition-colors"
                        >
                            <Smartphone className="h-4 w-4" /> Open in the Wayly app
                        </a>
                    )}
                    {token && !done && (
                        <p className="mt-2 text-[11px] text-[#6B7280] text-center">Have the app installed? Reset it there, or continue below.</p>
                    )}
                    {done ? (
