...
Three were flagged HIGH. A transport charge, code TR-003 on 12 June, had been billed twice at 89 dollars, so 178 dollars instead of 89. A personal care visit on 11 June, code PC-001, was delivered by a substitute worker with no notice given. A registered nurse visit on 17 June, code RN-001, was also a substitution, this time with less than 24 hours notice.

Four were flagged MEDIUM. Care management was 20 dollars and 82 cents above the 10 per cent cap for the quarter. A brokered podiatry visit carried a 7 dollar premium above the published rate. A garden maintenance charge was sitting in a stream that did not look right and needed a classification query. And 482 dollars and 62 cents of the quarterly budget was at risk of being forfeited as underspend.

Two were informational. A previous period adjustment had been correctly applied, so no action needed. And 720 dollars of assistive technology funding for grab rails was still committed and waiting to be used.
...
If you are not satisfied, you have backup. The [Older Persons Advocacy Network](https://opan.org.au) runs a free advocacy line on 1800 700 600. The Aged Care Quality and Safety Commission can investigate overcharging and now has the power to order refunds. [My Aged Care](https://www.myagedcare.gov.au) on 1800 200 422 can help with broader questions about your funding.`,
    ...
    },
    {
        ...
        key_takeaways: [
            "Support at Home funding is paid as a quarterly budget tied to your classification level, with 10 per cent set aside for care management.",
            "You can carry over up to 1,000 dollars or 10 per cent of the quarterly budget, whichever is greater, to the next quarter. Anything above that is lost.",
...
Ten per cent of each quarterly budget is deducted for care management, which covers planning, coordination and review by your provider. That leaves about 90 per cent for the services in your care plan.`,
            },
            {
                ...
                body_md: `This is where families lose money without realising. At the end of a quarter, unspent funds roll over, but only up to a ceiling. The amount that carries over is the higher of 1,000 dollars or 10 per cent of your quarterly budget. Anything above that does not carry across and is returned to the system.
...
The point is to give you the numbers before the quarter ends, not after, when nothing can be done.`,
            },
            {
                ...
                body_md: `Dorothy Anderson is on Support at Home Level 4 with Bluebell Care Services. Level 4 is 29,696 dollars and 40 cents a year, which works out to about 7,424 dollars and 10 cents a quarter.
...
If the budget keeps falling short or keeps building up, that is a signal. A shortfall may mean it is time for a reassessment to a higher classification. A steady underspend may mean the care plan needs a refresh.`,
        ...
        howto: {
            ...
            steps: [
                ...
                { name: "Read the result", text: "Wayly shows your care management against the 10 per cent cap, your rollover ceiling and how much budget remains." },
        ...
        faqs: [
            ...
            { q: "How much of my budget goes to care management?", a: "Ten per cent of each quarterly budget is set aside for care management. The Wayly Budget Calculator flags it if a provider charges above that cap." },
...
That gave Daniel the confidence to request a support plan review, and a clear picture of the changes to describe when the assessor called. He did not have to argue from a vague worry. He had specifics.`,
        ...
        howto: {
            ...
            steps: [
                ...
                { name: "Decide your next step", text: "If the result points to a review, request one through My Aged Care or use the Wayly Reassessment Letter Generator." },
            ],
        },
        faqs: [
            ...
            { q: "What is the difference between Level 3 and Level 4?", a: "Funding. Level 3 is 21,965 dollars and 70 cents a year and Level 4 is 29,696 dollars and 40 cents a year, effective 1 November 2025. A higher level means a larger budget for more or more intensive services." },
    ...
    },
    {
        ...
        meta: {
            title: "Wayly Reassessment Letter Generator: Request a Review",
            description: "The Wayly Reassessment Letter Generator writes a clear letter to My Aged Care requesting a Support at Home reassessment. Editable and saved to your vault.",
        },
        key_takeaways: [
            ...
            "The Wayly Reassessment Letter Generator produces a formatted letter to My Aged Care, which you can edit and which is saved to your Wayly vault.",
...
This is exactly the kind of writing that is hard to do under stress, which is where Wayly helps.`,
            ...
            {
                heading: "How Wayly's Reassessment Letter Generator does this for you",
                body_md: `The [Wayly Reassessment Letter Generator](/ai-tools/reassessment-letter) takes the details of your parent's situation and turns them into a clear, properly structured letter to My Aged Care requesting a reassessment or support plan review.
...
Daniel edited a couple of lines to add that Patricia's GP could provide a supporting report, then saved the letter to his Wayly vault. He had a clear, specific request rather than a rushed phone call, and a copy on file for when he rang [My Aged Care](https://www.myagedcare.gov.au) on 1800 200 422 to follow up.`,
            ...
            {
                heading: "Try the Wayly Reassessment Letter Generator",
                body_md: `Do not let a good case stall over a hard to write letter. Use the [Wayly Reassessment Letter Generator](/ai-tools/reassessment-letter) to produce a clear request to My Aged Care, edit it to fit your parent, and keep a copy in your Wayly vault.`,
            },
        ],
        howto: {
            ...
            steps: [
                { name: "Open the Generator", text: "Visit the Wayly Reassessment Letter Generator at /ai-tools/reassessment-letter." },
        ...
        faqs: [
            ...
            { q: "Can I edit the letter the Wayly Reassessment Letter Generator creates?", a: "Yes. Every part is editable, so the letter stays in your own words. It is then saved to your Wayly vault for your records and any follow up." },
...
It also showed the effect of the 1 October 2026 change, since Robert uses personal care, which will become free from that date. And it tracked his progress against the 135,318 dollar and 69 cent lifetime cap that applies to him as a participant under the new arrangements. With those numbers in front of her, the family could plan Robert's services around a budget they understood rather than a surprise invoice.`,
        ...
        howto: {
            ...
            steps: [
                ...
                { name: "Review the estimate", text: "Wayly returns contribution percentages and dollar figures across Clinical Care, Independence and Everyday Living, with lifetime cap progress." },
            ],
        },
        faqs: [
            ...
            { q: "What is the Support at Home lifetime cap?", a: "For new participants it is 135,318 dollars and 69 cents, as at 20 September 2025. For the no worse off cohort it is 84,571 dollars and 66 cents. Both are indexed on 20 March and 20 September each year." },
    ...
    },
    {
        ...
        meta: {
            title: "Wayly Care Plan Reviewer: Does Your Care Plan Match?",
            description: "The Wayly Care Plan Reviewer checks your Support at Home care plan against your classification, service adequacy and the 10% care management cap.",
        },
        key_takeaways: [
            ...
            "The Wayly Care Plan Reviewer checks your plan against your classification, service adequacy and the care management cap.",
        ],
...
The bigger problem is when the plan does not match the classification. If a parent is funded at Level 4 but the plan only schedules a fraction of what that budget could deliver, the funding goes underused and the parent goes under supported. That mismatch is easy to miss, because the plan looks fine on its own. You only see it when you hold the plan up against the level and the budget.`,
            },
            {
                ...
                body_md: `Care management covers the planning and coordination your provider does, and it is funded by deducting 10 per cent from your quarterly budget. That cap protects the rest of your funding for actual services.
...
If care management is running above 10 per cent, less is left for care, and the plan may be quietly squeezed. Checking the care management figure against the cap is part of checking whether the plan is sound.`,
            ...
            {
                heading: "How Wayly's Care Plan Reviewer does this for you",
                body_md: `The [Wayly Care Plan Reviewer](/ai-tools/care-plan-reviewer) reads your care plan and checks it against the things that matter. You upload the plan and Wayly works through it.
...
The result is a clear read on whether your plan is making full use of your funding, or whether there are gaps to raise with your care manager. It turns a document that is hard to judge into a set of specific questions you can ask.`,
            },
            {
                ...
                body_md: `Dorothy Anderson is on Support at Home Level 4 with Bluebell Care Services, which is 29,696 dollars and 40 cents a year, about 7,424 dollars and 10 cents a quarter. Her daughter Catherine wanted to know whether Dorothy's care plan was really making use of that funding.

Catherine uploaded the plan to the Wayly Care Plan Reviewer. The Reviewer checked the scheduled services against the Level 4 budget and found that the plan was leaving funding underused, which lined up with the 482 dollar and 62 cent underspend the [Wayly Budget Calculator](/ai-tools/budget-calculator) had flagged for the same quarter. It also picked up the care management charge running 20 dollars and 82 cents above the 10 per cent cap, and a garden maintenance service sitting in a stream that needed a classification query.
...
With that, Catherine had a focused agenda for her next call with Susan Tran. Rather than asking whether the plan was fine, she could ask why the funding was underused, why care management was over the cap, and whether the garden service was in the right stream. The plan got tightened to actually match Dorothy's level.`,
            ...
            {
                heading: "Try the Wayly Care Plan Reviewer",
                body_md: `A care plan should earn its keep. Upload your parent's plan to the [Wayly Care Plan Reviewer](/ai-tools/care-plan-reviewer) and see whether it matches their level, uses their funding and stays within the care management cap.`,
            },
        ],
        howto: {
            name: "How to review a Support at Home care plan with Wayly",
            description: "Upload your care plan and Wayly checks it against your classification, service adequacy and the 10 per cent care management cap.",
            steps: [
                { name: "Open the Reviewer", text: "Visit the Wayly Care Plan Reviewer at /ai-tools/care-plan-reviewer." },
        ...
        faqs: [
            ...
            { q: "How much can a provider charge for care management?", a: "Up to 10 per cent of your quarterly budget. The Wayly Care Plan Reviewer checks the care management charge against that cap." },
            { q: "Can the Wayly Care Plan Reviewer tell me if my plan matches my level?", a: "Yes. It checks the scheduled services against your classification's funding, so you can see whether the plan uses the budget your level provides or leaves it underused." },
