...
export const POLICIES = [
        ...
        sections: [
            {
                ...
                paragraphs: [
                    "Personal care services include help with showering, dressing, grooming, toileting and continence support. Today they sit in the Independence stream and a participant contribution applies (5% for a full age pensioner, 17.5% for a part age pensioner, 50% for a self funded retiree).",
            ...
            },
            {
                ...
                paragraphs: [
                    "Before October 2026 a personal care hour at $78 costs a full age pensioner $3.90 from their pocket and $74.10 from their quarterly Independence budget. After October the same hour costs the pensioner zero. The full $78 comes from the quarterly Independence budget. Where families overpaid out of pocket before, this is now genuine cash flow relief.",
    ...
    },
    {
        ...
        sections: [
            {
                ...
                paragraphs: [
                    "The guarantee covers any participant who was an active Home Care Package recipient on 31 October 2025. The participant's classification under Support at Home cannot reduce the package level they held. The participant's contribution rate cannot be higher than it was under the previous package arrangement.",
                ],
            },
            {
                ...
                bullets: [
                    ...
                    "The contribution rate on the day of transition",
        ...
        faqs: [
            { q: "How do I check the guarantee applies to me?", a: "Log in to My Aged Care or call 1800 200 422. They can confirm your package level on 31 October 2025 and your current contribution rate." },
