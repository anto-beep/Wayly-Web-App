...
export const FAQ_GROUPS = [
    {
        ...
        questions: [
            ...
            { q: "Is Support at Home means tested?", a: "Yes. Your contribution percentage for Independence and Everyday Living services depends on your pension status (full age, part age, or self funded). Clinical Care is free for everyone." },
        ],
    },
    {
        ...
        questions: [
            ...
            { q: "What is the rollover cap?", a: "Approximately 10 per cent of the quarterly budget, with a floor of $1,000. Anything unspent above the cap is forfeited at quarter end." },
            { q: "Why does my hourly rate matter so much?", a: "Your contribution is a percentage of the published rate. If your provider charges above the published rate you pay 100 per cent of the gap. A small rate increase quietly accelerates your budget burn." },
    ...
    },
    {
        ...
        questions: [
            ...
            { q: "How much does Wayly cost?", a: "Free plan with one decoded statement per month and one participant. Solo $19 per month. Family $39 per month. Adviser $299 per month. Cancel anytime." },
