...
export const GUIDES = [
    // ---------- Batch D: problem-aware ----------
    {
        ...
        faqs: [
            ...
            { q: "What if the assessment outcome seems wrong?", a: "Ask for a reassessment. The Reassessment Letter tool can draft this for you in plain English." },
        ],
        related: [
            { href: "/ai-tools/reassessment-letter", label: "Reassessment Letter tool", sub: "Draft a request in plain English" },
    ...
    },
    {
        ...
        faqs: [
            ...
            { q: "What is the difference between gross and participant share?", a: "Gross is the full hourly rate times hours. Participant share is the gross times your contribution percentage. The rest comes from your quarterly budget." },
        ],
        related: [
    ...
    },
    {
        ...
        description: "Sibling disagreements about aged care are common. Here is how to navigate them calmly so the parent does not become the battleground.",
