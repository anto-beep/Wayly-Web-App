...
export const SERVICES = [
    ...
    },
    {
        ...
        keyTakeaways: [
            ...
            "Cost varies. Delivered meals usually 12 to 18 dollars per meal",
        ],
        sections: [
            {
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                note: "Until 1 October 2026 the existing contribution percentages apply (5 per cent full age pension, 17.5 per cent part age pension, 50 per cent self funded).",
            },
        ],
        faqs: [
    ...
    },
    {
        ...
        related: [
            ...
            { href: "/ai-tools/care-plan-reviewer", label: "Care Plan Reviewer", sub: "Check your care plan is up to date" },
        ],
    },
    {
        slug: "respite",
