...
export const SERVICES = [
    {
        ...
        sections: [
            ...
            {
                heading: "Questions to ask before the first clean",
                bullets: [
                    "Which specific rooms and tasks are included at the agreed rate",
                    "Whether the same cleaner comes each visit, or it rotates",
                    "How much notice you need to give to cancel without a fee",
                    "Whether products are supplied, and whether they suit any allergies",
                ],
                note: "Getting these in writing at the start avoids the two most common cleaning disputes: what was actually agreed, and what a cancellation costs.",
            },
        ],
        faqs: [
    ...
    },
    {
        ...
        sections: [
            ...
            {
                heading: "Framing gardening as falls prevention",
                paragraphs: [
                    "Overgrown paths, wet leaves on steps, and hidden trip hazards are a common cause of falls at home. It often helps to frame garden maintenance as a safety measure rather than tidiness, both in your own planning and at the care plan review. A safety framing can support a case for more frequent visits when the yard is large or the participant is unsteady.",
                ],
                note: "If a specific hazard needs a one off fix, such as a loose paver or an overhanging branch near the door, ask whether it belongs under gardening or under the Assistive Technology and Home Modifications scheme.",
            },
        ],
        faqs: [
    ...
    },
    {
        ...
        sections: [
            ...
            {
                heading: "Booking and cancellation, the practical rules",
                bullets: [
                    "Book recurring trips (dialysis, day centre) as a standing order so the slot is held",
                    "Get the cancellation notice period in writing, short notice often attracts a fee",
                    "Confirm whether the driver waits or returns, this changes the cost",
                    "For specialist clinics, allow buffer time so a late appointment does not overrun the booking",
                ],
            },
        ],
        faqs: [
    ...
    },
    {
        ...
        sections: [
            ...
            {
                heading: "Keeping meal costs under control",
                bullets: [
                    "Compare delivered meal prices per unit, they range widely between services",
                    "Use in-home prep on the days that suit and delivered meals for the rest",
                    "Ask whether a weekly plan attracts a discount over ad hoc ordering",
                    "Check that a special diet is not adding an avoidable premium",
                ],
            },
        ],
        faqs: [
    ...
    },
    {
        ...
        sections: [
            ...
            {
                heading: "What a typical personal care visit looks like",
                paragraphs: [
                    "A morning personal care visit usually runs 30 to 60 minutes. The worker helps the participant shower or wash, dress, groom, and take any set out medication (a nurse still handles medication administration). Many households add a short tidy of the bathroom at the end. A consistent worker at a consistent time of day makes the visit calmer and quicker for everyone.",
                ],
            },
        ],
        faqs: [
    ...
    },
    {
        ...
        sections: [
            ...
            {
                heading: "Coordinating nursing with the GP and pharmacy",
                paragraphs: [
    ...
    },
    {
        ...
        sections: [
            ...
            {
                heading: "Making the first respite stay work",
                bullets: [
                    "Do a short familiarisation visit before the first overnight stay",
                    "Write a one page routine: sleep, meals, medication, comfort items",
                    "Pack familiar objects, a photo, a blanket, a favourite mug",
                    "Plan the return so the first day home is quiet, not busy",
                ],
            },
        ],
        faqs: [
    ...
    },
    {
        ...
        sections: [
            ...
            {
                heading: "Matching the activity to the person",
                paragraphs: [
                    "Social support only works when it fits the person. A lifelong reader may prefer a quiet companion and a library trip. A former club member may thrive in a group. Ask what the participant enjoyed at 40 and 60, not just what they manage now. Culturally and linguistically specific groups often lift engagement far more than a generic day centre.",
                ],
            },
        ],
        faqs: [
