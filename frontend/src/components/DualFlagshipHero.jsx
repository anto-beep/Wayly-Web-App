    ...
    return (
        ...
        >
            ...
            <div className="relative mx-auto max-w-7xl px-6 pt-14 pb-20 lg:pt-20 lg:pb-24">
                ...
                <Reveal>
                    <div className="inline-flex items-center gap-2 rounded-full bg-[#0E4D52] px-4 py-2 text-sm sm:text-base font-bold uppercase tracking-[0.16em] text-white shadow-md" data-testid="hero-kicker">
                        <Sparkles className="h-4 w-4" aria-hidden="true" />
                        Wayly
                    </div>
                    <h1
                        className="mt-3 font-heading font-black uppercase tracking-[-0.02em] leading-[0.95] text-[2rem] sm:text-4xl lg:text-5xl text-primary-k"
        ...
        >
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                    <span className={`inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-bold uppercase tracking-[0.12em] text-white shadow-sm ${accent === "clay" ? "bg-[#A5512B]" : "bg-[#0E4D52]"}`}>
