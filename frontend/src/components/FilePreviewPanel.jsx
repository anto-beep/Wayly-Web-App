            ...
            <div className="flex items-start justify-between gap-3">
                <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {isHeic && (
                            <div className="text-xs text-muted-k mt-1">iPhone/iPad photo, we will convert it for you.</div>
                        )}
                        {isWord && (
                            <div className="text-xs text-muted-k mt-1">We will extract the text and decode your statement.</div>
                        )}
                        {isPdf && (
                            <div className="text-xs text-muted-k mt-1">PDF detected, we will handle text or scanned automatically.</div>
                        )}
                        {overLimit && (
