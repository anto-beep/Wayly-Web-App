        ...
        <div className="min-h-screen bg-kindred">
            ...
            <article className="mx-auto max-w-3xl px-6 pt-10 pb-16">
                ...
                <footer className="mt-12 pt-6 border-t border-[#CFE0F0] text-xs text-[#4A5A75]" data-testid="content-trust">
                    Reviewed and Published by Wayly Editorial. Updated {updatedAt}. Spot something wrong? Email <a href="mailto:support@wayly.com.au" className="text-[#075866] font-medium underline underline-offset-2">support@wayly.com.au</a>.
                </footer>
            </article>
            </main>
