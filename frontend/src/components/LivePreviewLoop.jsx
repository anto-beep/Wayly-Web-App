    ...
    return (
        <div className="bg-[#EAF4FB] p-6 w-full max-w-3xl mx-auto" aria-hidden="true">
            ...
            <div className="grid grid-cols-3 gap-3 mt-4">
                {[
                    { l: "Clinical", t: "$195.00", c: "#3DB8A8", d: 0 },
                    { l: "Independence", t: "$570.00", c: "#0E2A47", d: 0.6 },
                    { l: "Everyday Living", t: "$337.50", c: "#2BC4D6", d: 1.2 },
                ].map((s) => (
                    <div
                        key={s.l}
                        className="bg-white border border-[#CFE0F0] rounded-xl p-3 kindred-fadein"
            ...
            <div
                className="mt-4 bg-white border-l-[3px] border-[#E07A5F] rounded-r-md p-3 shadow-[0_2px_12px_rgba(197,115,77,0.18)] kindred-anomaly-flash"
            >
