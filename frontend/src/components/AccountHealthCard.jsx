    ...
    return (
        <div className="relative h-[92px] w-[92px] flex-none" data-testid="account-health-ring">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                <span className="font-heading text-xl leading-none tabular-nums" data-testid="account-health-score">{pct}%</span>
        ...
        >
            ...
            >
                ...
                <div className="flex-1 min-w-0 text-white">
                    <div className="font-heading text-xl leading-tight text-white">
