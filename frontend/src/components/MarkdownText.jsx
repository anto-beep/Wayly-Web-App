            ...
            <ReactMarkdown
                ...
                components={{
                    ...
                    strong: ({ node, children, ...p }) => {
                        ...
                        if (raw && raw.trim().length <= 28) {
                            return (
                                <strong className="font-semibold rounded-md bg-gold/20 text-primary-k px-1.5 py-0.5 mx-0.5 whitespace-nowrap" {...p}>
                                    {children}
                                </strong>
                            );
                        }
                        return <strong className="font-semibold" {...p}>{children}</strong>;
                    },
