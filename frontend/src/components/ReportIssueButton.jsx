...
export default function ReportIssueButton({
    ...
    return (
        ...
        >
            {isInline && (
                <span className="text-xs font-semibold uppercase tracking-wider text-[#C2683D]">
                    Something not right?
                </span>
            )}
            <button
                ...
                className={
                    isInline
                        ? "inline-flex items-center gap-1.5 rounded-full bg-[#C2683D] px-3.5 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-[#A85735] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C2683D] focus-visible:ring-offset-2"
                        : "inline-flex items-center gap-2 rounded-full bg-[#C2683D] px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-[#A85735] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C2683D] focus-visible:ring-offset-2"
                }
