...
// INV-UI filter bar. Mirrors StatementFilters so the Invoices screen filters
// the same way as Statements. Filters are AND-combined; a "Clear filters"
// chip appears when any are active, and a live result count stays visible.
...
export default function InvoiceFilters({
    ...
    return (
        <div className="flex flex-wrap items-center gap-2" data-testid="invoices-filter-bar">
            <div className="relative">
                ...
                <input
                    ...
                    placeholder="Search provider, invoice number, filename…"
            ...
            <MultiSelect
                ...
                testid="invoices-provider-filter"
            />
            ...
            <div className="ml-auto text-xs text-muted-k tabular-nums" data-testid="invoices-result-count">
