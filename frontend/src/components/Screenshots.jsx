...
export function BrowserFrame({ url = "app.wayly.com.au", scale = 0.85, className = "", children, label }) {
    return (
        <figure aria-label={label} className={`block max-w-full ${className}`}>
            <div aria-hidden="true" inert={true} className="rounded-[10px] overflow-hidden shadow-[0_24px_64px_rgba(0,0,0,0.15)] border border-[#E2E2E2] bg-[#F5F5F5]">
