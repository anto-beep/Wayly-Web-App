                ...
                <ol className="mt-3 space-y-3 text-sm text-primary-k">
                    <li className="flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-muted-k text-xs mt-0.5">From any inbox, forward the statement (with the original PDF/Word attachment) to the address above. We will decode it within ~30 seconds.</p>
                        </div>
                    </li>
                    <li className="flex gap-3">
                    ...
                    <li className="flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-muted-k text-xs mt-0.5">We will reply to confirm receipt and link straight to the decoded statement on your dashboard.</p>
                        </div>
                    </li>
                </ol>
            </div>
