                    ...
                    <div className="border-t border-kindred/40 bg-surface-2 px-3 py-2.5">
                        <div className="flex items-end gap-2">
                            <textarea
                                ...
                                onKeyDown={onKeyDown}
                                placeholder={expired ? "Subscribe to ask Wayly questions" : "Ask anything…"}
                                rows={1}
                                className="flex-1 resize-none rounded-lg border border-kindred/60 bg-surface px-3 py-2 text-sm text-primary-k placeholder:text-muted-k focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold max-h-28 disabled:bg-surface-2 disabled:cursor-not-allowed"
