...
- **Auth pages no longer use dark mode** (`App.js` AppearanceScope + `components/AccessibilityWidget.jsx` applyPrefs): /login, /signup, /forgot, /reset, /verify-email always render light (identical to light mode) regardless of the saved appearance pref — fixes the unreadable Google button in dark mode. Verified: forcing appearance=dark still renders /login light.
