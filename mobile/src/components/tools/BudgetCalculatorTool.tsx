    ...
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
        <ScrollView ref={scrollRef} contentContainerStyle={{ padding: spacing.lg, paddingBottom: spacing.xxl, gap: spacing.md }} keyboardShouldPersistTaps="handled">
          ...
          {/* Supplements */}
          <Card testID="bc-supplements" style={{ backgroundColor: colors.goldSoft, borderColor: colors.gold, borderWidth: 1 }}>
            <T style={{ fontFamily: fonts.bodySemi, fontSize: 11, letterSpacing: 1, color: colors.gold }}>APPLICABLE SUPPLEMENTS (OPTIONAL)</T>
          ...
          {result ? (
            ...
            <ResultActions mode="payload" tool="budget" payload={result} fileBaseName={`wayly-budget-class-${classification}`} testIDPrefix="bc-export" />
            </View>
          ) : null}
