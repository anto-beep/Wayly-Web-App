      ...
      <View style={{ flexDirection: "row", gap: spacing.md }}>
        ...
        <View style={{ flex: 1 }}>
          <View style={{ flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", gap: spacing.sm }}>
            <View style={{ flex: 1 }}>
              <T style={{ fontFamily: fonts.bodySemi, fontSize: 11, letterSpacing: 1, color: colors.primary }}>{eyebrow}</T>
              <T style={{ fontFamily: fonts.headingSemi, fontSize: 18, marginTop: 2, color: colors.primary }}>{title}</T>
            </View>
            {refreshable ? (
              <Pressable
