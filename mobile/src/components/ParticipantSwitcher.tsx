...
import { ChevronDown, CheckCircle2, HeartHandshake } from "lucide-react-native";
  ...
  if (variant === "bar") {
    return (
      <>
        ...
        >
          <View style={[styles.avatarLg, { backgroundColor: `${colors.primary}22` }]}>
