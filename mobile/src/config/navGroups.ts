...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Budget & Lifetime Cap Calculator", route: "/tool/budget-calculator", icon: Wallet, implemented: true },
      { label: "Provider Price Checker", route: "/tool/provider-price-checker", icon: FileBarChart, implemented: true },
      { label: "Classification Self-Check", route: "/tool/classification-self-check", icon: ListChecks, implemented: true },
      { label: "Letters & Follow-ups", route: "/tool/letters-and-follow-ups", icon: FilePenLine, implemented: true },
      { label: "Contribution Estimator", route: "/tool/contribution-estimator", icon: ReceiptText, implemented: true },
      { label: "Support Plan Reviewer", route: "/tool/care-plan-reviewer", icon: ClipboardCheck, implemented: true },
      { label: "Aged Care Q&A", route: "/tool/family-coordinator", icon: MessageCircle, implemented: true },
    ],
  },
  {
    key: "money",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "SAH Classification Prep", route: "/classification-prep", icon: ClipboardList, implemented: true },
