...
function LegacyStatementView({ stmt, colors }: { stmt: Statement; colors: any }) {
  ...
  return (
    <>
      {stmt.summary ? (
        <Card testID="summary-card" style={{ backgroundColor: colors.primarySoft }}>
      ...
      {anomalies.length > 0 ? (
        <Card testID="anomalies-card" style={{ backgroundColor: colors.goldSoft }}>
      ...
      <Card testID="line-items-table" style={{ backgroundColor: colors.sageSoft }}>
