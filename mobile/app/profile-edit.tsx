    ...
    <Card testID="profile-email-card">
      ...
      {status?.pending ? (
        ...
        <View testID="email-change-form" style={{ marginTop: spacing.md, gap: spacing.sm }}>
          <Field label="New email address" required testID="email-change-new-input" value={newEmail} onChangeText={setNewEmail} autoCapitalize="none" keyboardType="email-address" placeholder="you@example.com" />
          <Field label="Confirm your password" required testID="email-change-password-input" value={password} onChangeText={setPassword} secureTextEntry placeholder="Current password" />
