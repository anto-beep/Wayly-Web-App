...
class TestBilling:
    def test_checkout_solo_authenticated(self, auth_headers):
        r = requests.post(
            ...
            json={"plan": "solo", "origin_url": "https://final-verify-web.preview.emergentagent.com"},
    ...
    def test_checkout_invalid_plan(self, auth_headers):
        r = requests.post(
            f"{BASE_URL}/api/billing/checkout",
            json={"plan": "lifetime", "origin_url": "https://final-verify-web.preview.emergentagent.com"},
