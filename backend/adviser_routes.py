...
def _public_origin() -> str:
    """Best-effort origin for the deep-link in the invite email. Order:
      1. FRONTEND_URL env var (per-environment override, e.g. preview).
      2. PUBLIC_APP_URL env var (canonical production URL).
      3. Legacy PUBLIC_APP_ORIGIN env var (kept for back-compat).
      4. Hardcoded https://wayly.com.au fallback.
    """
    return (
