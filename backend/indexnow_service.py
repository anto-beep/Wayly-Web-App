...
# Key is env-overridable so it can be rotated without a code change. When you
# rotate INDEXNOW_KEY you must also publish a matching public/<newkey>.txt at the
# site root (the receiving engines fetch that exact file to verify ownership).
_DEFAULT_INDEXNOW_KEY = "0dd78cc1f170c03893e727376ba77ef7624e6f6b4015ea1727d3dd3415147ae2"
INDEXNOW_KEY = os.environ.get("INDEXNOW_KEY", _DEFAULT_INDEXNOW_KEY).strip() or _DEFAULT_INDEXNOW_KEY
HOST = "wayly.com.au"
