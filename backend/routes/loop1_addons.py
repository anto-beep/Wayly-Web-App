...
async def lca1_digest(body: LCA1DigestBody, request: Request):
    ...
    text_body = (
        ...
        "Sign in: https://mobile-web-sync-35.preview.emergentagent.com/app\n"
    )
    html_body = f"""
...
<p><a href="https://mobile-web-sync-35.preview.emergentagent.com/app" style="background:#1a3a2e;color:white;padding:10px 20px;text-decoration:none;border-radius:20px;">Open Wayly</a></p>
