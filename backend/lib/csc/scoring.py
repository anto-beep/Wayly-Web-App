...
def _budget_lookup(classification: int) -> int:
    ...
    try:
        ...
        _FALLBACK = {1: 11010, 2: 16451, 3: 22537, 4: 30469, 5: 40730,
                     6: 49365, 7: 59660, 8: 80137}
        return _FALLBACK.get(classification, 0)


def _quarterly_from_annual(annual: int) -> int:
    """Official quarterly budget = annual / 4. This INCLUDES the 10% care
    management allocation, matching the Department of Health schedule and the
    figure printed on the participant's statement."""
    return int(round(annual / 4.0))
