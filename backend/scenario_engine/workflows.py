...
WORKFLOWS: Dict[str, Dict[str, Any]] = {
    "reassessment": {
        ...
        "intro": (
            ...
            "last classification. Walk through the steps below, we will capture "
        ...
        "steps": [
            ...
            _step(
                ...
                payload_fields=[
                    {"key": "new_classification", "label": "New classification level (1 to 8)",
        ...
        "follow_up": (
            ...
            "28 days. We cannot recommend whether to appeal, talk to your "
    ...
    "death": {
        ...
        "intro": (
            "We're sorry. There is no rush, these steps can be done in your "
        ...
        "steps": [
            _step(
                ...
                body=(
                    "Capture the date the participant passed. We will keep the "
            ...
            _step(
                ...
                body=(
                    ...
                    "of death. We will surface a reminder if it is getting close."
                ),
                event_type=None,
                cta="I have told them",
            ),
            _step(
                ...
                body=(
                    ...
                    "we will close out the participant timeline."
                ),
                event_type=None,
